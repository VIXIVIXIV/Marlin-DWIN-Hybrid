 ...
 */
  ...
  #define PID_FAN_SCALING
    ...
    //#define PID_FAN_SCALING_ALTERNATIVE_DEFINITION
      ...
      #define PID_FAN_SCALING_AT_FULL_SPEED 10        //=PID_FAN_SCALING_LIN_FACTOR*255+DEFAULT_Kf
      #define PID_FAN_SCALING_AT_MIN_SPEED 6.0          //=PID_FAN_SCALING_LIN_FACTOR*PID_FAN_SCALING_MIN_SPEED+DEFAULT_Kf
      #define PID_FAN_SCALING_MIN_SPEED 22            // Minimum fan speed at which to enable PID_FAN_SCALING
 ...
 */
//#define USE_CONTROLLER_FAN @Ben Don't bother with the separate pin, just run it parallel to the hotend fan
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 20*60, 2.5*60 } // Feedrates for manual moves along X, Y, Z, E from panel
...
// Scroll a longer status message into view
  ...
  // Add an 'M73' G-code to set the current percentage
    ...
    //#define LCD_SET_PROGRESS_MANUALLY //@Monoprice
  #endif
#endif
...
//#define LCD_SHOW_E_TOTAL
  ...
  //#define BROWSE_MEDIA_ON_INSERT //Broken under extui right now
 ...
 */
 #if ANY(SKR13, SKR14, SKR14Turbo, SKRPRO11)
  #define FWRETRACT // Disabled firmware retract, will set via slicer profiles 
#endif
 ...
 */
   ...
   *
   * It is recommended to set [XYZ]_HOMING_BUMP_MM to 0.
   *
